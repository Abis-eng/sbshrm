...
urlpatterns = [
    ...
    path('api/chat/send/', views.send_chat_message, name='send_chat_message'),  # send message API
    path('api/chat/messages/<str:recipient_username>/', views.get_chat_messages, name='get_chat_messages'),  # get messages API
    path('api/chat/new-messages/', views.get_new_messages, name='get_new_messages'),  # get new messages API
    ...
    path('edit-ticket/<int:ticket_id>/', views.edit_ticket, name='edit_ticket'),  # admin edit ticket
    ...
    path('edit-department/<int:department_id>/', views.edit_department, name='edit_department'),  # admin
    path('delete-department/<int:department_id>/', views.delete_department, name='delete_department'),  # admin
    path('department/<int:department_id>/employees/', views.department_employees, name='department_employees'),  # admin
    ...
    path('edit-designation/<int:designation_id>/', views.edit_designation, name='edit_designation'),  # admin
    path('delete-designation/<int:designation_id>/', views.delete_designation, name='delete_designation'),  # admin
    path('designation/<int:designation_id>/employees/', views.designation_employees, name='designation_employees'),  # admin
    ...
    path('edit-holiday/<int:holiday_id>/', views.edit_holiday, name='edit_holiday'),  # admin
